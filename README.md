...
- `set total` - сеттер, устанавливающий количество товаров в корзине;
...
- `get basketList` - геттер, получающий массив товаров в корзине;
- `get total` - геттер, получающий количество товаров в корзине.
